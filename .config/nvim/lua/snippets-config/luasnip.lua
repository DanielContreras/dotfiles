...
for _, ft_path in ipairs(vim.api.nvim_get_runtime_file("lua/snippets-config/ft/*.lua", true)) do
	loadfile(ft_path)()
end
...
vim.keymap.set("n", "<leader><leader>s", "<cmd>source ~/.config/nvim/lua/snippets-config/luasnip.lua<CR>")
